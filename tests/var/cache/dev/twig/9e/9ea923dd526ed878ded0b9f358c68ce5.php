...
class __TwigTemplate_68c953a4bb7205f52f4162159a1b0378 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("base.backoffice.html.twig", "categorie/index.html.twig", 1);
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["categorie"]) {
            ...
            echo "            <tr>
                <td>";
            // line 22
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["categorie"], "idCategorie", [], "any", false, false, false, 22), "html", null, true);
            echo "</td>
                <td>";
            // line 23
            echo ((twig_get_attribute($this->env, $this->source, $context["categorie"], "espacecouvert", [], "any", false, false, false, 23)) ? ("Yes") : ("No"));
            echo "</td>
                <td>";
            // line 24
            echo ((twig_get_attribute($this->env, $this->source, $context["categorie"], "espaceenfants", [], "any", false, false, false, 24)) ? ("Yes") : ("No"));
            echo "</td>
                <td>";
            // line 25
            echo ((twig_get_attribute($this->env, $this->source, $context["categorie"], "espacefumeur", [], "any", false, false, false, 25)) ? ("Yes") : ("No"));
            echo "</td>
                <td>";
            // line 26
            echo ((twig_get_attribute($this->env, $this->source, $context["categorie"], "servicerestauration", [], "any", false, false, false, 26)) ? ("Yes") : ("No"));
            echo "</td>
                <td>
                    <a href=\"";
            // line 28
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_categorie_show", ["idCategorie" => twig_get_attribute($this->env, $this->source, $context["categorie"], "idCategorie", [], "any", false, false, false, 28)]), "html", null, true);
            echo "\">show</a>
                    <a href=\"";
            // line 29
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_categorie_edit", ["idCategorie" => twig_get_attribute($this->env, $this->source, $context["categorie"], "idCategorie", [], "any", false, false, false, 29)]), "html", null, true);
            echo "\">edit</a>
                </td>
            </tr>
        ";
...
{% endblock %}
", "categorie/index.html.twig", "C:\\Users\\Adem Tounsi\\Desktop\\viragecomWeb\\templates\\categorie\\index.html.twig");
    }
}
