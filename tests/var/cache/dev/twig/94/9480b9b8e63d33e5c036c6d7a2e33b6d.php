...
class __TwigTemplate_88ebabbe76fb6feccb550d14e9dc0c22 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        if (twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 11, $this->source); })()), "user", [], "any", false, false, false, 11)) {
            // line 12
            echo "            <div style=\"padding-top: 200px\" class=\"w-4/5 m-auto text-center\">
                <div class=\"mb-3\">
            ...
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 16, $this->source); })()), "user", [], "any", false, false, false, 16), "roles", [], "any", false, false, false, 16));
...
";
    ...
    {
        return array (  193 => 70,  185 => 65,  172 => 55,  146 => 32,  136 => 24,  129 => 20,  126 => 19,  117 => 17,  113 => 16,  108 => 14,  104 => 12,  102 => 11,  99 => 10,  93 => 8,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
    ...
    <form method=\"post\">
        ...
        {% if app.user %}
            <div style=\"padding-top: 200px\" class=\"w-4/5 m-auto text-center\">
                <div class=\"mb-3\">
                    You are logged in as {{ app.user.email }}, your roles are:
                    <ul>
...
{% endblock %}
", "security/login.html.twig", "C:\\Users\\Adem Tounsi\\Desktop\\viragecomWeb\\templates\\security\\login.html.twig");
    }
}
