 ...
 */
class getEspacepartenaireRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EspacepartenaireRepository' shared autowired service.
     *
     * @return \App\Repository\EspacepartenaireRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EspacepartenaireRepository.php';

        return $container->privates['App\\Repository\\EspacepartenaireRepository'] = new \App\Repository\EspacepartenaireRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
