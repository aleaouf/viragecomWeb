...
class ReponseController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager,int $idReclamation,ReclamationController $recCont,BadWordFilter $badWordFilter, ReclamationRepository $recRepo,MailerInterface $mailer): Response
    {
        ...
        $reponse->setIdReclamation($idReclamation);
        ...
        return $this->redirectToRoute('app_reponse_idReclamation', ['idReclamation' => $idReclamation], Response::HTTP_SEE_OTHER);
            }
    ...
    public function edit(Request $request, Reponse $reponse, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_reponse_admin', ['idReclamation' => $reponse->getIdReclamation()], Response::HTTP_SEE_OTHER);
        }
